...
class Sprite():
    ...
    def setScale(self, scale):
        self.image = pygame.transform.scale(self.image, scale * (self.image.get_width() * 1.0, self.image.get_height()* 1.0))
    ...
    def draw(self, mainScreen):
        ...
        position = [position[0] - mainScreen.camera.position[0], position[1] - mainScreen.camera.position[1]]
        image = self.image
